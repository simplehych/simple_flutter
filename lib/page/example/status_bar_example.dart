...
void main() => runApp(new StatusBarExample());

class StatusBarExample extends StatefulWidget {
  StatusBarExample();

  factory StatusBarExample.forDesignTime() {
    return new StatusBarExample();
  }

  @override
  _StatusBarExampleState createState() => new _StatusBarExampleState();
}
