        ...
        child: Column(
          children: <Widget>[
            ...
            Padding(
              ...
              child: Text(detail.subtitle,style: TextStyle(color: Colors.white,fontSize: 20.0,fontFamily: "Roboto"),),
            ),
            RawMaterialButton(
                ...
                onPressed: () {
                  NavigatorManager.goPage(context,
                      WxPublicAccountArticlePage(detail.id, detail.title));
                }),
          ],
        ),
      );
