...
class AnimationDemoHome extends StatefulWidget {
  ...
  AnimationDemoHome(dataList, {Key key}) : super(key: key) {
...
class _AnimationDemoHomeState extends State<AnimationDemoHome> {
  ...
  @override
  void initState() {
    allSections = getSections(widget.dataList);
    super.initState();
  }
      ...
      sectionCards.add(LayoutId(
        ...
        child: GestureDetector(
            ...
            onTapUp: (TapUpDetails details) {
              ...
              /// 点击跳转
              NavigatorManager.goPage(
                  context,
                  WxPublicAccountArticlePage(widget.dataList[index]["id"],
